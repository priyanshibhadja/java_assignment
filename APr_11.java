...
class APr_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("PRIYANSHI BHADJA",25,'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("KRUPA", 26, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("DHRUVI", 20, 'M');
